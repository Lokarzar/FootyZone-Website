...
import { searchPlayer, getPlayerStats, getTopScorers, getTopAssisters,getCountries, getTeams, getLeagues } from "/src/footySource.js";
...
const model = {
  ...
  countriesPromiseState: { data: null, loading: false, error: null },
  ...
  async getPlayerStats(playerId, season, context = null) {
    ...
    try {
      const data = await getPlayerStats(playerId, this.searchParam.season);
